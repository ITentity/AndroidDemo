...
public class ProgressActivity extends BaseAcvtivity implements View.OnClickListener{
    ...
    private void showCustomProgressNotify(String status) {
        ...
        mRemoteViews.setImageViewResource(R.id.custom_progress_icon, R.mipmap.sing_icon);
