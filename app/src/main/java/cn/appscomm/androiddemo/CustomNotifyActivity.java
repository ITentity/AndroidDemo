...
import cn.appscomm.androiddemo.tool.BaseTools;
...
public class CustomNotifyActivity extends BaseAcvtivity implements View.OnClickListener {
    /** TAG */
    ...
    public void shwoNotify(){
        ...
        view_custom.setImageViewResource(R.id.custom_icon, R.mipmap.ic_launcher_round);
